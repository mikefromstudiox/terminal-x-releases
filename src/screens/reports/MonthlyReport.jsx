        ...
        {!loading && data && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-slate-50">
                      ...
                      <th className="text-right px-4 py-2.5 text-[10px] font-bold text-slate-400 uppercase tracking-wider">Tickets</th>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
                <div className="px-5 py-4 border-b border-slate-100">
                  <p className="text-[12px] font-bold text-slate-700">{lang === 'es' ? 'Comprobantes por Tipo' : 'Receipts by Type'}</p>
                </div>
                <table className="w-full">
                  <thead>
                    <tr className="bg-slate-50">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t-2 border-slate-200 bg-slate-50">
                      <td className="px-5 py-3 text-[12px] font-bold text-slate-700">TOTAL</td>
              ...
              <table className="w-full">
                ...
                <tbody>
                        ...
                        <tr key={i} className="border-t border-slate-100 hover:bg-slate-50/50">
                          <td className="px-5 py-3">
                            <div className="flex items-center gap-2.5">
                              ...
                              <span className="text-[13px] font-semibold text-slate-800">{lang === 'es' ? m.es : m.en}</span>
                            </div>
                          </td>
                          <td className="px-5 py-3 text-[12px] text-slate-600 text-right">{cnt}</td>
                          <td className="px-5 py-3 text-[13px] font-bold text-slate-800 text-right">{fmtRD(m.amount)}</td>
                          <td className="px-5 py-3">
                  ...
                  <tr className="border-t-2 border-slate-200 bg-slate-50">
                    ...
                    <td className="px-5 py-3 text-[13px] font-bold text-slate-800 text-right">{fmtRD(data.metrics.cobrado)}</td>
                    <td />
                  </tr>
                </tbody>
              </table>
