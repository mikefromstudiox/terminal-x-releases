        ...
        {tickets.map(t => (
          <div key={t.id} className="flex items-center h-14 border-b border-slate-100 px-5 hover:bg-slate-50/60 transition-colors">
            ...
            <div className="flex-1 min-w-0 pr-3">
              <p className="text-[12px] font-semibold text-slate-800 truncate">{t.client_name || '—'}</p>
              <p className="text-[11px] text-slate-400 truncate">{t.cajero_name || '—'}</p>
            </div>
            <div className="w-[120px] shrink-0 pr-3">
              <span className="text-[12px] text-slate-700 truncate block">{t.vehicle_plate || '—'}</span>
            </div>
              ...
              {loadingTickets ? (
                ...
                <>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-[130px] shrink-0">
                          <p className="text-[13px] font-bold text-slate-800">{g.name}</p>
                        ...
                        <div className="w-[80px] shrink-0 text-center">
                          <p className="text-[15px] font-bold text-slate-700">{g.ticketCount}</p>
                          <p className="text-[10px] text-slate-400">{L('tickets', 'tickets')}</p>
                        </div>
                        {/* Total billed */}
                        <div className="w-[130px] shrink-0 text-right">
                          <p className="text-[12px] font-semibold text-emerald-700">{fmtRD(g.totalBilled)}</p>
                          <p className="text-[10px] text-slate-400">{L('facturado', 'billed')}</p>
                        </div>
                        {/* Commission + bar */}
                  ...
                  <div className="flex items-center gap-4 px-5 py-3 bg-slate-50 border-t border-slate-200">
                    ...
                    <div className="w-[80px] shrink-0 text-center">
                      <p className="text-[14px] font-bold text-slate-700">{summary.totalTickets}</p>
                    </div>
                    <div className="w-[130px] shrink-0 text-right">
