...
export const CONTABILIDAD_CALENDAR_TEMPLATES = [
  ...
  // PF anticipos cuatrimestrales (junio/septiembre/diciembre) — modeled as 3
  // annual rows since dueDateFor() only knows 'monthly' and 'annual'.
  ...
  // RST regimen (Norma 06-2018) — annual DJ
...
export function applicableTemplates({ regimen = 'ordinario', persona = 'pj' } = {}) {
  // EIRL is a juridical entity for tax purposes — files same forms as PJ.
