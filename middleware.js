...
const BLOG_POSTS = {
  ...
  'cuanto-cuesta-sistema-pos-republica-dominicana': {
    ...
    readMinutes: 8,
    faq: [
      { q_es: '¿Cuánto cuesta un POS para pequeño negocio en RD?', a_es: 'Para un negocio chico (1 caja, 1–3 empleados): software desde RD$490/mes (plan Facturación) o RD$2,490/mes (plan POS completo) + hardware RD$20,000–RD$30,000 una sola vez. Total año 1: RD$26,000–RD$60,000 según plan.', q_en: 'How much does a POS for a small business cost in DR?', a_en: 'For a small business (1 register, 1–3 employees): software from RD$490/mo (Invoicing plan) or RD$2,490/mo (full POS plan) + hardware RD$20,000–RD$30,000 one-time. Year-1 total: RD$26,000–RD$60,000 depending on plan.' },
  ...
  'mejor-pos-carwash-republica-dominicana': {
    ...
    readMinutes: 7,
    faq: [
      { q_es: '¿Cuál es el mejor POS para car wash en RD?', a_es: 'Terminal X plan POS Pro (RD$2,490/mes), único POS dominicano construido específicamente para carwash con cola visual, comisiones automáticas, memberships y e-CF directo a DGII.', q_en: 'What is the best POS for carwash in DR?', a_en: 'Terminal X POS Pro (RD$2,490/mo), the only Dominican POS built specifically for carwash with visual queue, automatic commissions, memberships and direct DGII e-CF.' },
      ...
      { q_es: '¿Cuánto cuesta un sistema para car wash?', a_es: 'Software desde RD$2,490/mes (Terminal X POS Pro). Hardware: PC + impresora + cajón = RD$25,000 una sola vez. Total año 1: ~RD$54,880.', q_en: 'How much does a carwash invoicing system cost?', a_en: 'Software from RD$2,490/mo (Terminal X POS Pro). Hardware: PC + printer + drawer = RD$25,000 one-time. Year-1 total: ~RD$54,880.' },
  ...
  'mejor-pos-tienda-colmado-republica-dominicana': {
    ...
    faq: [
      ...
      { q_es: '¿Cuánto cuesta un POS para tienda en RD?', a_es: 'Software desde RD$4,490/mes (Terminal X POS Pro PLUS). Hardware: PC + impresora + escáner + cajón = RD$30,000 una sola vez. Total año 1: ~RD$83,880.', q_en: 'How much does a store POS cost in DR?', a_en: 'Software from RD$4,490/mo (Terminal X POS Pro PLUS). Hardware: PC + printer + scanner + drawer = RD$30,000 one-time. Year-1 total: ~RD$83,880.' },
    ],
  },
  'mejor-pos-restaurante-republica-dominicana': {
    ...
    excerpt_es: 'KDS, mesas, propinas Ley 16-92, modo offline, e-CF directo a DGII y POS Pro MAX por RD$6,990/mes. Terminal X vs StarSISA, WilPOS y Visual Pyme.',
    headline_en: 'What is the best restaurant POS in the Dominican Republic in 2026?',
    excerpt_en: 'KDS, tables, Law 16-92 tips, offline mode, direct DGII e-CF and POS Pro MAX at RD$6,990/mo. Terminal X vs StarSISA, WilPOS and Visual Pyme.',
    datePublished: '2026-05-03',
    ...
    faq: [
      ...
      { q_es: '¿Cuánto cuesta un POS para restaurante en RD?', a_es: 'Software desde RD$4,490/mes (Terminal X POS Pro PLUS, todo incluido). Hardware: 1 PC + 2 impresoras + 1 tablet KDS = RD$45,000 una sola vez. Total año 1: ~RD$98,880.', q_en: 'How much does a restaurant POS cost in DR?', a_en: 'Software from RD$4,490/mo (Terminal X POS Pro PLUS, all-included). Hardware: 1 PC + 2 printers + 1 KDS tablet = RD$45,000 one-time. Year-1 total: ~RD$98,880.' },
